...
\[2\] *"The role of jobs with high greening potential in macroeconomic performance and sustainability"*, *Work in progress*.<button class="btn btn-sm btn-outline-secondary abstract-toggle"
...
\[1\] *"Greening jobs in the Global South: a critical and sectoral analysis of the potential for environmental transition"*, *Working paper*.<button class="btn btn-sm btn-outline-secondary abstract-toggle"data-bs-toggle="collapse" data-bs-target="#absWP2" aria-expanded="false" aria-controls="absWP2">Abstract</button>
