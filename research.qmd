...
[3] **Mathieu**, A., Rihi, Y., Massera, M., Moign, L., Nguirane, M.M., Madioune, E.M.,
Randriantseheno, M., Pian, L. (2025). « Inégalités doctorales entre les Nords et les Suds :
une première exploration depuis la littérature »,  
in Meyer, J.-B., Benguerna, M., Lounaci, A. (Eds.) *Études doctorales africaines : Diversité
de situations et enjeux communs*. Éditions IRD & African Minds.  
ISBN: [978-2-7099-3080-2](https://www.editions.ird.fr/produit/747/9782709930802/etudes-doctorales-africaines)<span style="margin-right:1rem;"></span><button class="btn btn-sm btn-outline-secondary abstract-toggle"
...
qui affectent les doctorant·e·s africain·e·s. Le chapitre met en évidence l’héritage colonial, la
marginalisation des savoirs locaux, le déficit de financement, les obstacles à la mobilité, la précarité
académique et les disparités d’employabilité. Il propose une typologie des inégalités doctorales et
souligne la nécessité de collaborations plus équitables et de capacités institutionnelles renforcées
pour une science plus inclusive et durable.
:::

[2] **Mathieu**, A., Geronimi, V., Taranco, A. (2025). « COVID-19 et réponses insulaires :
une analyse ouverte avec le jeu de données SIECRT », in Clément, M. et al. (Eds.)
*Politiques de développement, acteurs et évaluations*. EME Louvain (à paraître).<span style="margin-right:1rem;"></span><button class="btn btn-sm btn-outline-secondary abstract-toggle"
...
Chapitre présentant le jeu de données SIECRT, qui documente 8 mesures sanitaires prises par  
26 petites économies insulaires non-indépendantes entre 2020 et 2021. Il montre que l’insularité  
favorise une forte capacité d’anticipation — les PEI adoptant leurs premières mesures avant  
l’apparition de cas — tandis que le statut politique influe marginalement sur les temporalités  
et les choix politiques. L’analyse souligne le rôle de la science ouverte dans la construction  
de données comparatives fiables et la nécessité d’adapter les politiques sanitaires aux  
spécificités structurelles des PEI.
:::

[1] **Mathieu**, A., Rihi, Y. (2025). « Penser les transitions justes dans les Suds :
enjeux et perspectives de quantification pour les politiques d’emplois verts », in Clément, M. et al. (Eds.)
*Politiques de développement, acteurs et évaluations*. EME Louvain (à paraître).<span style="margin-right:1rem;"></span><button class="btn btn-sm btn-outline-secondary abstract-toggle"
...
Chapitre analysant les limites conceptuelles et opérationnelles des emplois verts dans les Suds  
à partir d’une grille de lecture critique des transitions justes. Il met en évidence les tensions  
entre impératifs de développement, prédominance de l’informalité et cadre global de mesure,  
puis discute la pertinence du *Just Transition Score*. L’étude propose des pistes méthodologiques  
pour adapter les instruments de quantification aux réalités socio-économiques locales et intégrer  
pleinement l’emploi comme levier central de transitions justes.
:::
