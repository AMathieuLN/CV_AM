...
**Mathieu**, A., Rihi, Y., Massera, M., Moign, L., Nguirane, M.M., Madioune, E.M., Randriantseheno, M., Pian, L. (2025). « Inégalités doctorales entre les Nords et les Suds : une première exploration depuis la littérature »,\
in Meyer, J.-B., Benguerna, M., Lounaci, A. (Eds.) *Études doctorales africaines : Diversité de situations et enjeux communs*. Éditions IRD & African Minds. ISBN: [978-2-7099-3080-2](https://www.editions.ird.fr/produit/747/9782709930802/etudes-doctorales-africaines)

<button class="btn btn-sm btn-outline-secondary abstract-toggle" data-bs-toggle="collapse" data-bs-target="#abs3" aria-expanded="false" aria-controls="abs3">
