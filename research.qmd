...
\[2\] **Mathieu**, A., Pian, L., Ba, M., Madioune, E. M., Moign, L., N'Da, L., Nguirane, M. M., Randriant-seheno, M., Rihi, Y. (2023). *Disparités doctorales entre Nord et Sud : bilan et stratégies de coordination juste à l'UMI SOURCE (2022-2023).*〈[hal-04336522](https://hal-lara.archives-ouvertes.fr/hal-04336522)〉<button class="btn btn-sm btn-outline-secondary abstract-toggle" data-bs-toggle="collapse" data-bs-target="#absUMI2" aria-expanded="false" aria-controls="absUMI2">Abstract</button>
...
-   **12/2024 (Madagascar)** - Qualitative survey on the mobilisation of local resources by local authorities in Madagascar - Sponsor: Cultural Cooperation and Action Service (SCAC), French Embassy in Madagascar (1 month).
