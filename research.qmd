...
*Politiques de développement, acteurs et évaluations*. EME Louvain (à paraître).
...
Chapitre présentant le jeu de données SIECRT, qui documente 8 mesures sanitaires prises par 26 petites
économies insulaires non-indépendantes entre 2020 et 2021. Il montre que l’insularité favorise une forte
capacité d’anticipation — les PEI adoptant leurs premières mesures avant l’apparition de cas —
tandis que le statut politique influe marginalement sur les temporalités et les choix politiques. L’analyse
souligne le rôle de la science ouverte dans la construction de données comparatives fiables et la nécessité
d’adapter les politiques sanitaires aux spécificités structurelles des PEI.
:::
...
Chapitre analysant les limites conceptuelles et opérationnelles des emplois verts dans les Suds à partir
d’une grille de lecture critique des transitions justes. Il met en évidence les tensions entre impératifs
de développement, prédominance de l’informalité et cadre global de mesure, puis discute la pertinence
du Just Transition Score. L’étude propose des pistes méthodologiques pour adapter les instruments de
quantification aux réalités socio-économiques locales et intégrer pleinement l’emploi comme levier
central de transitions justes.
:::
