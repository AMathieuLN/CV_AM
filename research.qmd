...
in Meyer, J.-B., Benguerna, M., Lounaci, A. (Eds).  
**Études doctorales africaines : Diversité de situations et enjeux communs**.  
...
:::: {.panel-tabset .small .abstract-style}
### Abstract
Revue de littérature examinant les inégalités structurelles, socio-économiques, de genre et de mobilité 
qui affectent les doctorant·e·s africain·e·s.  
Le chapitre met en évidence l’héritage colonial, la marginalisation des savoirs locaux, le déficit de financement, 
les obstacles à la mobilité, la précarité académique et les disparités d’employabilité.  
Il propose une typologie des inégalités doctorales et souligne la nécessité de collaborations plus équitables 
et de capacités institutionnelles renforcées pour une science plus inclusive et durable.
::::
...
in Clément, M. et al. (Eds),  
**Politiques de développement, acteurs et évaluations**.  
EME Louvain *(forthcoming)*.

:::: {.panel-tabset .small .abstract-style}
### Abstract
Chapitre présentant le jeu de données SIECRT, qui documente 8 mesures sanitaires adoptées par  
26 petites économies insulaires non-indépendantes entre 2020 et 2021.  
L’étude montre que l’insularité favorise une forte capacité d’anticipation — les PEI adoptant leurs premières mesures 
avant l’apparition de cas — tandis que le statut politique n’influence que marginalement les temporalités.  
Le chapitre souligne l’importance de la science ouverte pour la construction de données fiables, 
ainsi que la nécessité d’adapter les politiques sanitaires aux spécificités structurelles des PEI.
::::
...
:::: {.panel-tabset .small .abstract-style}
### Abstract
Chapitre analysant les limites conceptuelles et opérationnelles des emplois verts dans les Suds à partir d’une grille critique 
des transitions justes.  
Il met en lumière les tensions entre impératifs de développement, poids de l’informalité et cadre global de mesure, 
puis discute la pertinence du *Just Transition Score*.  
L’étude propose des pistes méthodologiques pour adapter les instruments de quantification aux réalités socio-économiques locales 
et replacer l’emploi au cœur des transitions justes.
::::
