...
While the concept of ‘green’ jobs is gaining ground, its macroeconomic effects remain poorly studied, particularly in economies with high levels of informality. This study assesses the impact of jobs with high greening potential (EFPV) on growth, resilience to cyclical downturns and intergenerational sustainability (adjusted real savings). Using a panel covering economies in the North and South, we combine fixed effects models and two-stage IV estimation using a synthetic geographical instrument (geo_index) to identify the causal effect of the share of GPJ. The results reveal a causal growth dividend: an exogenous increase in GWPJ stimulates GDP and mitigates both the frequency and depth of prolonged downturns. Informality, as measured by the self-employment rate, does not significantly alter these effects. With regard to sustainability, quadratic estimates show a U-shaped relationship: below a threshold of 30–35% of EFPV, transition costs reduce net savings, while above this threshold there appears to be a real green benefit. These results shed light on the institutional and social conditions necessary to transform the greening of employment into a sustainable driver of growth and resilience.
:::
